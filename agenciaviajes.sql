...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2021 a las 23:45:16
...
(1, 'Miguel', 'miguelloza1@hotmail.com', 'hola k pedo wey'),
(2, 'Miguel', 'miguelloza1@hotmail.com', 'hola k pedo wey'),
(3, 'evample', 'kripi@pasta.cl', 'kripiipastaaaaaaa'),
(4, 'JZR', 'malopalroket@rl.ssl', 'XDXDXD pretty fun game');
